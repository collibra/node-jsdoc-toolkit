// If you update moderizr, don't forget to add an additional param to the main
// function execution. Look for "this, this.document" and make it "this, this.document, Modernizr" and
// substitute "document, undefined" with "document, Modernizr, undefined".
var Modernizr;


///=================================== Start updatable part modernizr core...
...
window.Modernizr = (function( window, document, Modernizr, undefined ) {
...
///=================================== Stop updatable part modernizr core...

     // Add Modernizr to the core and deny global access to it.
        core.libs.add('modernizr', core.object.copy(window.Modernizr), false);

///=================================== Start updatable part modernizr plugins...
     ...
     }(core.libs.get('modernizr')));
///=================================== Stop updatable part modernizr plugins...
